...
CERT=`aws acm list-certificates --region us-east-1 --profile awsbootstrap --output text \
...
GH_ACCESS_TOKEN=$(cat ~/.github/hello-aws-access-token)
GH_OWNER=$(cat ~/.github/hello-aws-owner)
GH_REPO=$(cat ~/.github/hello-aws-repo)
GH_BRANCH=master

# Deploy a stack containing some 'static', project-wide resources
echo -e "\n\n=========== Deploying setup.yml ==========="
